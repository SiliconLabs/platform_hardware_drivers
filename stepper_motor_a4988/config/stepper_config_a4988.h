...
#define A4988_STEPPER_MAX_RPM           250

/// Steps per revolution. Please configure this value according to the
/// used stepper motor's step count value.
#define A4988_STEPPER_MOTOR_STEPS_PER_REV 200
