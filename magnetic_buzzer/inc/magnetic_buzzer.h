...
******************************************************************************/
#ifndef MAGNETIC_BUZZER_H
#define MAGNETIC_BUZZER_H

#ifdef __cplusplus
extern "C"{
#endif

#include "sl_pwm_custom.h"
#include "sl_pwm_config.h"
...
typedef struct
{
  ...
  sl_pwm_config_t config;  /**< PWM configuration */
...
#define SL_PWM_OUTPUT_LOCATION  SL_PWM_OUTPUT_LOC
#else
#define  SL_PWM_OUTPUT_LOCATION  0 //0 for compatibility
#endif
...
#define PWM_INSTANCE_DEFAULT                                              \
  {                                                                       \
    SL_PWM_PERIPHERAL,                   /* PWM peripheral */             \
    (uint8_t)SL_PWM_OUTPUT_CHANNEL,      /* PWM channel */                \
    (uint8_t)SL_PWM_OUTPUT_PORT,         /* PWM output port */            \
    (uint8_t)SL_PWM_OUTPUT_PIN,          /* PWM output pin */             \
    SL_PWM_OUTPUT_LOCATION,              /* PWM output location */        \
  }
...
/***************************************************************************//**
 * @brief Initializes all necessary pins and peripherals used for the buzzer.
 *
 * @param[in] buzzer
...
/***************************************************************************//**
 * @brief Deinitializes all necessary pins and peripherals used for the buzzer.
 *
 * @param[in] buzzer
 *   The instance of buzzer_t.
 * See #buzzer_t object definition for the detailed explanation.
...
/***************************************************************************//**
 * @brief Sets the buzzer volume level in percentages (range[0..100%]).
 *
 * @param[in] buzzer
 *   The instance of buzzer_t.
 * See #buzzer_t object definition for the detailed explanation.
...
/***************************************************************************//**
 * @brief Gets the buzzer volume level in percentages (range[0..100%]).
 *
 * @param[in] buzzer
 *   The instance of buzzer_t.
 * See #buzzer_t object definition for the detailed explanation.
